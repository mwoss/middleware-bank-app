...
{
    default CreditInfo getCredit(Credit credit)
        throws DateFormatError,
               UnsupportedCurrencyException
    {
        return getCredit(credit, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CreditInfo getCredit(Credit credit, java.util.Map<String, String> context)
        throws DateFormatError,
               UnsupportedCurrencyException
    {
        try
        {
            return _iceI_getCreditAsync(credit, context, true).waitForResponseOrUserEx();
        }
        catch(DateFormatError ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<CreditInfo> getCreditAsync(Credit credit)
    {
        return _iceI_getCreditAsync(credit, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CreditInfo> getCreditAsync(Credit credit, java.util.Map<String, String> context)
    {
        return _iceI_getCreditAsync(credit, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<CreditInfo> _iceI_getCreditAsync(Credit iceP_credit, java.util.Map<String, String> context, boolean sync)
    {
    ...
    static final Class<?>[] _iceE_getCredit =
    {
